...
// funções para redimensionamento
	...
	*/
	...
	{
		//$corfundo = imagecolorallocatea( $this->img_temp, $this->rgb[0], $this->rgb[1], $this->rgb[2] );
		//imagefill( $this->img_temp, 0, 0, $corfundo );
                
                //@MOD
                $corfundo = imagecolorallocatealpha($this->img_temp, $this->rgb[0], $this->rgb[1], $this->rgb[2], 127);
                imagefill($this->img_temp, 0, 0, $corfundo);
	} // fim preencheImagem
