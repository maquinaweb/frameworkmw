<?php
	...
	class Template {
		...
		public function clear($varname) {
                ...
                /**
		 * Aplica o clear em todas as variáveis que se encaixam no regex
		 *
		 * @param     string $regex
		 * @return    void
		 */
		public function clearRegex($regex) {
                    $matches = preg_grep($regex, $this->vars);
